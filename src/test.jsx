  ...
  return (
    <div className="font-Playfair w-[100vw] " ref={Homecontainer}>
      ...
      <div className="h-[100vh] w-[100vw] bg-[#8b4513] flex justify-center items-center relative ">
        <h2 className="text-9xl font-extrabold text-[#e6ab0b] uppercase text-center absolute z-[14] gspaHomeHeaderTextClass">
          Nectar of Cakes
        </h2>
        <img
          src={coconutleaf}
          alt=""
          className=" absolute h-[100%] right-[0] top-[-10%] imagedropfilter z-[13]"
        />
        <img
          src={HeaderCakeImage}
          alt=""
          className="absolute h-[90%] imagedropfilter  z-[16] gsapHomeHeaderCakeClass gsapHomeHeaderCake1Class "
        />
        ...
        <img
          src={beeflap}
          alt=""
          className="absolute h-[30%] left-[75%] top-[12%] imagedropfilter  z-[14] gspaHomeBee1Class"
        />
        <img
          src={beeflap}
          alt=""
          className="absolute h-[30%] left-[5%] bottom-[10%] imagedropfilter rotateY180 z-[18] gspaHomeBee2Class"
        />
      </div>

      {/*Aboutus*/}
      {/* <div className="h-[100vh]  w-[100vw] flex bg-[#eece76] px-[5vw] gsapHomeAboutUsClass">
        <div className=" basis-1/2 relative  ">
          <img
            src={Blob}
            alt=""
            className="transform rotate-[231deg] h-[75%]  absolute bottom-[-6%]"
          />
        </div>
        <div className=" basis-1/2 flex flex-col justify-center items-start gsapHomeAboutusTextClass">
          <h2 className=" text-[#361513] text-5xl font-bold mb-5 transform duration-500 ease-in border-b-4 border-b-[#361513] pb-2 uppercase">
            About Us
          </h2>
